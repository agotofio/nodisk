...
<h2 class="text-2xl neon-text mb-2">🎁 Акции и Бонусы</h2>
<p class="mb-4">Следи за новостями и участвуй в розыгрышах!</p>
<ul class="text-sm text-gray-300 mb-4 space-y-1">
<li>🔥 Ежемесячные розыгрыши в Telegram</li>
<li>📦 Подарок за подписку на <a class="text-red-400 underline" href="https://t.me/magazin_muhicha2" target="_blank">наш канал</a></li>
<li>💬 Бонусы активным покупателям</li>
</ul>
<a class="shop-btn px-6 py-2 rounded inline-block" href="https://t.me/magazin_muhicha2" target="_blank">Участвовать</a>
</div>
</main>
